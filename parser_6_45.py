...
def get_data(html):
    ...
    date = soup.find('div', id='content').find('h1').text.strip().split('№')[1].split(',')[1][1:-8]
    ...
    return ''.join(number_edition), date, time, number_1, number_2, number_3, number_4, number_5, number_6, number_of_tickets, number_of_combinations, super_prize
    ...
    try:
        ...
        while a <= 50000: 
            ...
            _SQL = """insert into data
                    ...
                    number_4, number_5, number_6, number_of_tickets,
